...
**[Note for Windows users]** If no USB instruments are found and you don't already have a vendor VISA implementation installed, their might be some driver tweaks needed. See the **[Wiki](https://github.com/kerstensrobin/open-EE-workbench/wiki)** for the full walkthrough.
